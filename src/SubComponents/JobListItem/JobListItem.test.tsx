...
describe("JobListItem SubComponent", () => {
  ...
  it("Displays correct overall progress", () => {
    ...
    expect(
      container1.querySelector(".JobListItem__Progress"),
    ...
    expect(
      container2.querySelector(".JobListItem__Progress"),
  ...
  it("Displays correct status", () => {
    ...
    expect(container1.querySelector(".JobListItem__Status")).toHaveTextContent(
      "In Queue",
    );
    ...
    expect(container2.querySelector(".JobListItem__Status")).toHaveTextContent(
      "In Progress",
    );
    ...
    expect(container3.querySelector(".JobListItem__Status")).toHaveTextContent(
      "Completed",
    );
  });
  ...
  it("Has as many children as sub jobs", () => {
    ...
    expect(
      container1.querySelector(".JobListItem__SubJobList")?.children.length,
    ).toBe(2);
    ...
    expect(
      container2.querySelector(".JobListItem__SubJobList")?.children.length,
    ).toBe(4);
  });
});
